...
namespace Rock.Migrations
{
    ...
    ///
    /// </summary>
    public partial class AddAdditionalContentPlatform : Rock.Migrations.RockMigration
    {
        /// <summary>
        ...
        public override void Up()
        {
            ...
            // Intentionally hide the tv app page for now
            Sql( @"UPDATE [Page] 
        ...
        {
            // Page Detail Attribute for BlockType: TV Page List
            RockMigrationHelper.DeleteAttribute( "3BC9944D-35E2-466D-B7CC-9507BE108084" );
            // Remove Block: Site List, from Page: Apple TV Apps, Site: Rock RMS
            RockMigrationHelper.DeleteBlock( "2ED8AA54-A7F5-4EB9-91BC-043CC5EC2433" );
            // Remove Block: Apple TV Page Detail, from Page: Application Screen Detail, Site: Rock RMS
            RockMigrationHelper.DeleteBlock( "F110B685-07EC-49A7-90AB-E02C67AEC68A" );
            // Remove Block: TV Page List, from Page: Application Detail, Site: Rock RMS
            RockMigrationHelper.DeleteBlock( "57711B0B-C5B0-4F8E-B190-32410EDC2C89" );
            // Remove Block: Apple TV Application Detail, from Page: Application Detail, Site: Rock RMS
            RockMigrationHelper.DeleteBlock( "B7A5BBF5-B03F-47F1-A459-258927185EA7" );

            // Delete BlockType TV Page List
            RockMigrationHelper.DeleteBlockType( "7BD1B79C-BF27-42C6-8359-F80EC7FEE397" ); // TV Page List
            // Delete BlockType Apple TV Page Detail
            RockMigrationHelper.DeleteBlockType( "23CA8858-6D02-48A8-92C4-CE415DAB41B6" ); // Apple TV Page Detail
            // Delete BlockType Apple TV Application Detail
            RockMigrationHelper.DeleteBlockType( "49F3D87E-BD8D-43D4-8217-340F3DFF4562" ); // Apple TV Application Detail

                        
            // Delete Page Application Screen Detail from Site:Rock RMS
            RockMigrationHelper.DeletePage( "6CC8D008-8D30-416D-8A36-7D01B72A2518" ); //  Page: Application Screen Detail, Layout: Full Width, Site: Rock RMS
            // Delete Page Start Screen from Site:Rock TV
            RockMigrationHelper.DeletePage( "ED4341EB-3846-48B4-96D3-444D3ABBF389" ); //  Page: Start Screen, Layout: Homepage, Site: Rock TV
            // Delete Page Apple TV Apps from Site:Rock RMS
            RockMigrationHelper.DeletePage( "C8B81EBE-E98F-43EF-9E39-0491685145E2" ); //  Page: Apple TV Apps, Layout: Full Width, Site: Rock RMS
        }
    }
}
